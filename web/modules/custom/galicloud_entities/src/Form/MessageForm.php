  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($result) {
      case SAVED_NEW:
        ...
        $this->logger('galicloud_entities')->notice('Created new message %label', $logger_arguments);
        break;

      case SAVED_UPDATED:
        $this->messenger()->addStatus($this->t('The message %label has been updated.', $message_arguments));
        $this->logger('galicloud_entities')->notice('Updated message %label.', $logger_arguments);
        break;
    }
