...
/**
 * Defines the 'galicloud_entities_galicloud_color' field type.
 *
 * @FieldType(
 *   id = "galicloud_entities_galicloud_color",
 *   label = @Translation("Galicloud Color"),
 ...
 */
class GalicloudColorItem extends FieldItemBase {
